...
export class Univ3NFT__positionsResult {
  value0: BigInt;
  value1: Address;
  value2: Address;
  value3: Address;
...
export class Univ3NFT extends ethereum.SmartContract {
  static bind(address: Address): Univ3NFT {
    return new Univ3NFT("Univ3NFT", address);
  }
  ...
  positions(tokenId: BigInt): Univ3NFT__positionsResult {
    let result = super.call(
      "positions",
    ...
    return new Univ3NFT__positionsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toAddress(),
  ...
  try_positions(
    tokenId: BigInt
  ): ethereum.CallResult<Univ3NFT__positionsResult> {
    let result = super.tryCall(
      "positions",
      "positions(uint256):(uint96,address,address,address,uint24,int24,int24,uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
